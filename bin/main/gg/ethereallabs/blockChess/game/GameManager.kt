...
import gg.ethereallabs.blockChess.gui.PromotionGUI
import gg.ethereallabs.blockChess.gui.SurrendGUI
...
object GameManager {
    ...
    val playersDrawing : MutableMap<UUID, Game> = ConcurrentHashMap()
